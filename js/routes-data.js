    ...
    trips: [
      {
        ...
        entries: [
          ...
          { type: "photo", src: "2.jpg", caption: "左圖在下方等待的隊員，右圖在上方架繩的先鋒馨儀、元泓" },
          { type: "photo", src: "3.jpg" },
          { type: "photo", src: "4.jpg" },
          ...
          { type: "text", text: "15:00 過地形：馨儀帶主繩先鋒攀登瀑布上方進行人身確保，達波隨後拉繩上去架設固定點。固定點架設完畢後，其他隊員使用普魯士上升（或上升器traxion或Jumar）。\n左圖在瀑布上方的馨儀以及正在攀爬的劉教練；右圖在瀑布上方的視角。" },
